...
namespace ParameterClasses
{
    public class DateTimeSharpC
    {
        ...
        public static implicit operator DateTime(DateTimeSharpC Parameter)
        {
            return Parameter.Value;
        }

        public static implicit operator DateTimeSharpC(DateTime Value)
        {
            return new DateTimeSharpC(Value);
        }
        ...
        public DateTimeSharpC(DateTime Value)
        {
            this.Value = Value;
            InputObject = Value;
        }

        public DateTimeSharpC(string Value)
        {
            this.Value = ParseDateTime(Value);
            InputObject = Value;
        }

        public DateTimeSharpC(object InputObject)
        {
            if (InputObject == null)
